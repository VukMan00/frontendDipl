...
export const authenticate = async(memberData)=>{
    try{
        const response = await axios.post("http://localhost:8765/api/auth-service/auth/authenticate",memberData);
...
export const emailForPassowrd = async(email)=>{
    try{
        const response = await axiosPrivate.post("http://localhost:8765/api/auth-service/email/emailChangePassword",email);
...
export const changePassword = async(reqPassword)=>{
    try{
        ...
        const response = await axiosPrivate.post("http://localhost:8765/api/auth-service/auth/changePassword",reqPassword);
        return response;
    }catch(err){
...
export const emailPreRegister = async(email)=>{
    try{
        const response = await axios.post("http://localhost:8765/api/auth-service/email/preRegister",email);
        return response;
    }catch(err){
...
export const checkEmail = async(email)=>{
    try{
        const response = await axios.post("http://localhost:8765/api/auth-service/email/forgottenEmail",email);
        return response;
    }catch(err){
...
export const register = async(registerData)=>{
    try{
        const response = await axios.post("http://localhost:8765/api/auth-service/auth/register",registerData);
        return response.data;
    }catch(err){
...
export const logOut = async()=>{
    try{
        const response = await axiosPrivate.post('http://localhost:8765/api/auth-service/auth/logout');
        return response;
    }catch(err){
        console.error("Error with registration: " + err);
        throw err;
